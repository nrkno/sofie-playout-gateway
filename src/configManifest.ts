...
export const PLAYOUT_DEVICE_CONFIG: DeviceConfigManifest = {
	deviceConfig: [
		...
		},
		{
			...
			isSubDevices: true,
			deviceTypesMapping: {
				[TSRDeviceType.ABSTRACT]: DeviceType.ABSTRACT,
				[TSRDeviceType.CASPARCG]: DeviceType.CASPARCG,
				[TSRDeviceType.ATEM]: DeviceType.ATEM,
				[TSRDeviceType.LAWO]: DeviceType.LAWO,
				[TSRDeviceType.HTTPSEND]: DeviceType.HTTPSEND,
				[TSRDeviceType.PANASONIC_PTZ]: DeviceType.PANASONIC_PTZ,
				[TSRDeviceType.TCPSEND]: DeviceType.TCPSEND,
				[TSRDeviceType.HYPERDECK]: DeviceType.HYPERDECK,
				[TSRDeviceType.PHAROS]: DeviceType.PHAROS,
				[TSRDeviceType.OSC]: DeviceType.OSC,
				[TSRDeviceType.HTTPWATCHER]: DeviceType.HTTPWATCHER,
				[TSRDeviceType.SISYFOS]: DeviceType.SISYFOS,
				[TSRDeviceType.QUANTEL]: DeviceType.QUANTEL,

				[DeviceType.ABSTRACT]: TSRDeviceType.ABSTRACT,
				[DeviceType.CASPARCG]: TSRDeviceType.CASPARCG,
				[DeviceType.ATEM]: TSRDeviceType.ATEM,
				[DeviceType.LAWO]: TSRDeviceType.LAWO,
				[DeviceType.HTTPSEND]: TSRDeviceType.HTTPSEND,
				[DeviceType.PANASONIC_PTZ]: TSRDeviceType.PANASONIC_PTZ,
				[DeviceType.TCPSEND]: TSRDeviceType.TCPSEND,
				[DeviceType.HYPERDECK]: TSRDeviceType.HYPERDECK,
				[DeviceType.PHAROS]: TSRDeviceType.PHAROS,
				[DeviceType.OSC]: TSRDeviceType.OSC,
				[DeviceType.HTTPWATCHER]: TSRDeviceType.HTTPWATCHER,
				[DeviceType.SISYFOS]: TSRDeviceType.SISYFOS,
				[DeviceType.QUANTEL]: TSRDeviceType.QUANTEL
			},
